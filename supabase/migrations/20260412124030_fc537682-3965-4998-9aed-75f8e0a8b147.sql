...
-- Fix: get_conversion_candidates must be VOLATILE because it performs UPDATE operations
-- STABLE functions cannot write data, causing "Could not load conversion data" errors
