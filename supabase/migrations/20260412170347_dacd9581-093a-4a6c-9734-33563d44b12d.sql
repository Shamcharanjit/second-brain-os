...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'rates', jsonb_build_object(
      'signup_to_waitlist_email_rate', CASE WHEN v_waitlist_signed_up > 0 THEN LEAST(100, ROUND((v_waitlist_email_sent::numeric / v_waitlist_signed_up) * 100, 1)) ELSE 0 END,
      ...
      'activation_to_first_login_rate', CASE WHEN v_activation_completed > 0 THEN LEAST(100, ROUND((v_first_login::numeric / v_activation_completed) * 100, 1)) ELSE 0 END,
      'activation_to_first_capture_rate', CASE WHEN v_activation_completed > 0 THEN LEAST(100, ROUND((v_first_capture::numeric / v_activation_completed) * 100, 1)) ELSE 0 END,
      'activation_to_second_session_rate', CASE WHEN v_activation_completed > 0 THEN LEAST(100, ROUND((v_second_session::numeric / v_activation_completed) * 100, 1)) ELSE 0 END,
...
BEGIN
  ...
  -- Cap all rates at 100%
  v_activation_rate := CASE WHEN v_signups > 0 THEN LEAST(100, (v_activations::numeric / v_signups) * 100) ELSE 0 END;
  v_login_rate := CASE WHEN v_activations > 0 THEN LEAST(100, (v_first_login::numeric / v_activations) * 100) ELSE 0 END;
  v_capture_rate := CASE WHEN v_activations > 0 THEN LEAST(100, (v_first_capture::numeric / v_activations) * 100) ELSE 0 END;
  v_session_rate := CASE WHEN v_activations > 0 THEN LEAST(100, (v_second_session::numeric / v_activations) * 100) ELSE 0 END;
  v_day2_rate := CASE WHEN v_activations > 0 THEN LEAST(100, (v_day2::numeric / v_activations) * 100) ELSE 0 END;
  v_day7_rate := CASE WHEN v_activations > 0 THEN LEAST(100, (v_day7::numeric / v_activations) * 100) ELSE 0 END;
