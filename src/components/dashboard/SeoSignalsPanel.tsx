...
export default function SeoSignalsPanel() {
  ...
  const topPages = Array.isArray((data as any).top_pages) ? (data as any).top_pages : [];
  const topKeywords = Array.isArray((data as any).top_keywords) ? (data as any).top_keywords : [];
